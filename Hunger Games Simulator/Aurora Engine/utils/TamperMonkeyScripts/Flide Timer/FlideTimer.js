...
// Support multiple site patterns - add more checks here as needed
const isTCLP = currentURL.startsWith('https://flide.ap.tesla.services/3d/TCLP');
const isApviz = currentURL.includes('apviz');
const isPlaceholder = currentURL.includes('placeholder'); // Example: add your site pattern here
const isValidPage = isTCLP || isApviz || isPlaceholder; // Add new checks to this line

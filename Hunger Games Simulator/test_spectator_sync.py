...
class SpectatorTester:
    ...
    def test_spectator_joining(self):
    ...
    def test_lobby_creation(self):
        ...
        def lobby_created(data):
            ...
            print(f"   Lobby created event data keys: {list(data.keys()) if data else 'None'}")
    ...
    def test_spectator_join(self, lobby_id):
    ...
    def test_lobby_broadcasting(self):
...
def main():
    ...
    with SpectatorTester() as tester:
        success = tester.test_spectator_joining()

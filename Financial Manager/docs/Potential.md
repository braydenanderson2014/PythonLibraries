...
- system can help achieve your goals by finding ways to save money.. there can be certain levels that help determine how much cost cutting is warranted. Like if you are in serious debt, it could follow the advice of Dave ramsey and pay off what he recommends first. then move to bigger fish... this can link to all accounts and you can set locks on certain ones like savings...
**Data Structure**:
```json
{
  "goal_id": "goal_001",

...
class PaymentTrackerApp:
    ...
    def setup_ui(self):
        ...
        ttk.Button(input_frame, text="Add Payment", command=self.add_payment).grid(row=4, column=0, columnspan=2, pady=5)

        self.tree = ttk.Treeview(self.root, columns=("Date", "Amount", "Month", "Method"), show="headings")
    ...
    def refresh_dashboard(self):
        ...
        for p in payments:
            ...
            if month_filter != "Show All" and p["month"] != month_filter:
                continue
            self.tree.insert("", "end", values=(p["date"], f"${p['amount']:.2f}", p["month"], p["method"]))
    ...
    def add_payment(self):
        ...
        entry = {"date": date, "amount": amount, "month": month, "method": method}
    ...
    def export_current(self):
        ...
        try:
            ...
            with open(path, "w", newline="", encoding='utf-8') as f:
                ...
                writer.writerow(["Date", "Amount", "Month For", "Payment Method", "Balance After Payment"])
                ...
                payment_summary = self.calculate_payment_summary_with_auto_credits(monthly_totals, rent_amount, na_month_list)
    ...
    def export_all(self):
        ...
        try:
            with open(path, "w", newline="", encoding='utf-8') as f:
                ...
                writer.writerow(["Tenant", "Monthly Rent", "Date", "Amount", "Month For", "Payment Method", "Balance After Payment"])

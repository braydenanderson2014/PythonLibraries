...
DEFAULT_MCP_TOOLS = [
    ...
    MCPToolDescriptor("install_uv", "Install or plan uv bootstrap and PATH registration", mutating=True),
    MCPToolDescriptor("list_integration_tools", "List integration prerequisites such as git and docker"),
    MCPToolDescriptor("install_integration_tool", "Install or plan integration prerequisites", mutating=True),

  ...
  <Capabilities>
    ...
    def execute_signtool(self, config):
        ...
        try:
            ...
            # Check if certificate is available (you'd need to configure this)
            ...
            print(f"🔍 Command: {' '.join(signtool_cmd)}")
    ...
    def get_certificate_path(self):
        """Get path to code signing certificate"""
        # Check common certificate locations
        cert_locations = [
            'certificate.pfx',
            'signing_cert.pfx',
            os.path.expanduser('~/certificate.pfx'),
            os.path.expanduser('~/Documents/certificate.pfx')
        ]
